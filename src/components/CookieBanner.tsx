    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 mb-5">Usamos cookies para mejorar tu experiencia.</p>
        </div>
        <button
          type="button"
          onClick={onAccept}
        ...
        <div className="text-center text-xs text-[#999] cursor-pointer select-none" onClick={onReject}>
